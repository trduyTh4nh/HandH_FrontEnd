      ...
      <div className="cart-page_wrap flex flex-col w-full px-4 md:px-20 min-h-full">
        <div className="flex flex-col gap-0 w-full">
          <div className="z-10 bg-white w-full py-3 top-40 flex gap-2 items-center">
            ...
            <p>
              {cart.cart_products
                ? cart.cart_products.reduce((acc, cur) => acc + cur.quantity, 0)
                : 0}{" "}
              sản phẩm
            </p>
          </div>
        </div>
        <div className="cart-body h-full flex flex-col-reverse md:flex-row w-full gap-8 flex-grow">
          ...
          <div className="cart-body_right w-full relative md:w-1/3">
            <div className="cart-body_right_wrap fixed w-1/3 flex flex-col gap-2 pr-20">
